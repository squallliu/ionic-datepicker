  ...
  function IonicDatepicker($ionicPopup, $ionicModal, IonicDatepickerService) {
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        scope.titleLabel = scope.inputObj.titleLabel ? (scope.inputObj.titleLabel) : '日期选择';
        scope.todayLabel = scope.inputObj.todayLabel ? (scope.inputObj.todayLabel) : '今天';
        scope.closeLabel = scope.inputObj.closeLabel ? (scope.inputObj.closeLabel) : '关闭';
        scope.setLabel = scope.inputObj.setLabel ? (scope.inputObj.setLabel) : '确定';
        scope.showTodayButton = scope.inputObj.showTodayButton ? (scope.inputObj.showTodayButton) : 'true';
        scope.errorMsgLabel = scope.inputObj.errorMsgLabel ? (scope.inputObj.errorMsgLabel) : '请选择一个日期';
        ...
        scope.clearLabel = scope.inputObj.clearLabel ? (scope.inputObj.clearLabel) : '清除';
        scope.clearButtonType = scope.inputObj.clearButtonType ? (scope.inputObj.clearButtonType) : 'button-stable cal-button';
        scope.dateFormat = scope.inputObj.dateFormat ? (scope.inputObj.dateFormat) : 'yyyy-MM-dd';
        ...
        if (typeof(scope.inputObj.mondayFirst) === 'undefined') {
